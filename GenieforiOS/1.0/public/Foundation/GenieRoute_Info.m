...
//  Genie
//
//  Created by beyself on 10-12-13.
...
@implementation GenieRoute_Info
...
+ (GenieRoute_Info*) getRoute:(struct rt_msghdr2 *)rtm
{
    ...
    if(rtm->rtm_addrs & RTA_DST)
    {
        ...
        {
			route = [[GenieRoute_Info alloc] initWithRtm:rtm];
		}
    }
