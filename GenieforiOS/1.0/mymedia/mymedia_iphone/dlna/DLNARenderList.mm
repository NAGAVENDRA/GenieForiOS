...
#define REC_IS_PORTRAIT  CGRectMake(0.0f, 0.0f, 320.0f, 480.0f-50-self.tabBarController.tabBar.frame.size.height)
#define REC_IS_LANDSCAPE CGRectMake(0.0f, 0.0f, 480.0f, 320.0f-50-self.tabBarController.tabBar.frame.size.height)
...
//                                  initWithTitle:@"Please select a player" 
                                  initWithTitle:NSLocalizedStringFromTable(@"Select player", @"Localizable", nil)                                                             delegate:self
