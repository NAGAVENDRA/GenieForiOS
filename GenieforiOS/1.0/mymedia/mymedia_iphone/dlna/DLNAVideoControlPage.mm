...
- (void) initPageView
{
    ...
    volumeView.frame = CGRectMake(0, 0, 180, 10);
    ...
    progressView.frame = CGRectMake(0, 0, 230, 10);
    progressView.minimumValue = 0;
    [bg_view addSubview:progressView];
    
    leftProgress = [[UILabel alloc] init];
    leftProgress.frame = CGRectMake(0, 0, 60, 15);
    leftProgress.font = [UIFont systemFontOfSize:12];
    ...
    rightProgress.frame = CGRectMake(0, 0, 60, 15);
    rightProgress.font = [UIFont systemFontOfSize:12];
    ...
    mediaObjName.frame = CGRectMake(0, 0, 200, 20);
    mediaObjName.font = [UIFont systemFontOfSize:15];
...
- (void) layoutPageViewWithInterfaceOrientation:(UIInterfaceOrientation) orientation
{
    ...
    {
        controlBtnBg.center = CGPointMake(160.0f, rec.size.height*0.88);
        progressView.center = CGPointMake(160.0f, rec.size.height*0.58);
        volumeView.center = CGPointMake(160.0f+25.0f, rec.size.height*0.7);
        ...
        mediaObjName.center = CGPointMake(rec.size.width/2, rec.size.height*0.05);
    }
    else
    {
        controlBtnBg.center = CGPointMake(rec.size.width*0.9, rec.size.height/2);
        progressView.center = CGPointMake(200.0f, rec.size.height*0.58);
        volumeView.center = CGPointMake(200.0f+25.0f, rec.size.height*0.8);
        [(UIButton*)[bg_view viewWithTag:MUTE_BTN_TAG] setCenter:CGPointMake(volumeView.center.x-volumeView.frame.size.width/2-30, volumeView.center.y)];
        mediaObjName.center = CGPointMake(200.0f, rec.size.height*0.08);
    }
    
    leftProgress.center = CGPointMake(progressView.center.x-progressView.frame.size.width/2, progressView.center.y+18);
    rightProgress.center = CGPointMake(progressView.center.x+progressView.frame.size.width/2, progressView.center.y+18);
    [self showThumbImg];
}
...
- (void) layoutControlBtnsWithOrientation:(UIInterfaceOrientation) orientation
{
    ...
    if (orientation == UIInterfaceOrientationPortrait || orientation == UIInterfaceOrientationPortraitUpsideDown)
    {
        ...
        [(UIButton*)[controlBtnBg viewWithTag:PREVIOUS_BTN_TAG] setCenter:CGPointMake(305/8, 24)];
        [(UIButton*)[controlBtnBg viewWithTag:STOP_BTN_TAG] setCenter:CGPointMake(305/8+305/4, 24)];
        [(UIButton*)[controlBtnBg viewWithTag:PAUSE_PLAY_BTN_TAG] setCenter:CGPointMake(305/8+305/2, 24)];
        [(UIButton*)[controlBtnBg viewWithTag:NEXT_BTN_TAG] setCenter:CGPointMake(305/8+305*3/4, 24)];
    }
    else
    {
        controlBtnBg.frame = CGRectMake(0, 0, 58, 200);
        img = [UIImage imageNamed:@"controlBtnViewBg_LandscapeLR.png"];
        [(UIButton*)[controlBtnBg viewWithTag:PREVIOUS_BTN_TAG] setCenter:CGPointMake(29, 25)];
        [(UIButton*)[controlBtnBg viewWithTag:STOP_BTN_TAG] setCenter:CGPointMake(29, 75)];
        [(UIButton*)[controlBtnBg viewWithTag:PAUSE_PLAY_BTN_TAG] setCenter:CGPointMake(29, 125)];
        [(UIButton*)[controlBtnBg viewWithTag:NEXT_BTN_TAG] setCenter:CGPointMake(29, 175)];
    }
...
- (void) setBg_imgWithType:(DLNAMediaObjType) type
{
    //2011.2.9
    /*UIImage * bg_img = nil;
    if ((int)self.frame.size.width == 320)
    {
...
- (void) showThumbImg
{
    ...
    {
        //2012.2.9
        //thumbImgView.frame = CGRectMake(0, 0, 165.0f, 165.0f);
        [self scaleThumbImgViewIntoSquareWithLength:165.0f];
        thumbImgView.center = CGPointMake(160.0f, rec.size.height*0.32);
    }
    else
    {
        //2012.2.9
        //thumbImgView.frame = CGRectMake(0, 0, 80.0f, 80.0f);
        [self scaleThumbImgViewIntoSquareWithLength:80.0f];
        thumbImgView.center = CGPointMake(200.0f, rec.size.height*0.32);
    }
}
