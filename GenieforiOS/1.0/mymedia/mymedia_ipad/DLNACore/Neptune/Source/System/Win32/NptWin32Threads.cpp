...
NPT_RWLock::NPT_RWLock()
{
    m_Delegate = new NPT_Win32RWLock();
}

/*----------------------------------------------------------------------
|   NPT_Win32RWLock::NPT_Win32RWLock
+---------------------------------------------------------------------*/
NPT_Win32RWLock::NPT_Win32RWLock()
{
	m_cReaders = 0;
...
NPT_Result NPT_Win32RWLock::LockForRead()
{
...
NPT_Result NPT_Win32RWLock::LockForWrite()
{
	EnterCriticalSection(&m_csWrite);
	WaitForSingleObject(m_hevReadersCleared, INFINITE);
	return NPT_SUCCESS;
...
NPT_Result NPT_Win32RWLock::UnlockForRead()
{
	EnterCriticalSection(&m_csReaderCount);
	if (--m_cReaders == 0) {
...
NPT_Result NPT_Win32RWLock::UnlockForWrite()
{
	LeaveCriticalSection(&m_csWrite);
	return NPT_SUCCESS;
}
